...
class SecondScreen extends StatelessWidget {
  ...
  static GlobalKey<FormState> FormSecond = GlobalKey();
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButton(
                ...
                items: suaid
                    .map<DropdownMenuItem<String>>((spec) => DropdownMenuItem(
                          value: spec,
                          child: Text(spec),
                        ))
                    .toList(),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: myBlacks, borderRadius: BorderRadius.circular(45.0)),
        child: Row(
