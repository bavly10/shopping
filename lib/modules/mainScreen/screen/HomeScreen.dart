      ...
      child: Row(
        children: [
          Card(
            ...
            elevation: 1,
            child: IconButton(icon: Icon(Icons.search_sharp,size: 35,color: myBlue,),
                onPressed: (){
                  ShopCubit.get(context).changeSearchAppBar();
                }),
          ),
           SizedBox(width: MediaQuery.of(context).size.width*0.25,),
          Text(mytranslate(context, "home"),style: TextStyle(color: myBlack,fontWeight: FontWeight.bold,fontSize: 25),),
          Spacer(),
          MyArrowBack(onPress: (){
