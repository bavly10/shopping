    ...
    return BlocConsumer<LoginCubit,LoginStates>(
      listener: (ctx,state) {
        if (state is SucessLoginState) {
          ...
          if (state.error == "6004") {
            My_CustomAlertDialog(onPress: () => Navigator.pop(context),
                pressTitle: 'OK',
                context: context,
                icon: Icons.error,
                bigTitle: "shopping",
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                },title:state is LoadingLoginState?CircularProgressIndicator(color: myWhite,) :Text( mytranslate(context, "loginText2",),style: TextStyle(color: myWhite,fontSize: 18,fontWeight: FontWeight.bold)), hight: 0.08, width: 0.80,),
                const SizedBox(height: 25,),
